...
$query = "SELECT udescription, utitle FROM users WHERE uid = ?";
...
if ($result->num_rows > 0) {
    ...
    $user_info = $result->fetch_assoc(); // Fetch a single row, not all

    // Now you can access udescription and utitle like this:
    $udescription = $user_info['udescription'];
    $utitle = $user_info['utitle'];
} else {
    ...
    <div class="profile-main">
        <div class="profile-container">
            ...
            <div class="profile-container-inner">
                ...
                <div class="profile-container-inner">
                    <?php echo '<b id="currentTitle">'. $utitle .'</b>' ?>
        ...
        <div class="profile-description">
            ...
            <div class="textarea-container">
                <textarea id="description" name="description" rows="5" placeholder="Write about yourself..."><?php echo htmlspecialchars($udescription); ?></textarea>
                <?php 
